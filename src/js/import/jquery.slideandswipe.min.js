! function(a, b, c, d) {
    ...
    a.fn.slideAndSwipe = function(b) {
        function g(a, b, g, h) { "start" == b && (e = c.hasClass("ssm-nav-visible") ? 0 : d); var i; "move" == b && "left" == g ? (i = e < 0 ? e - h : -h, j(i, 0)) : "move" == b && "right" == g ? (i = e < 0 ? e + h : h, j(i, 0)) : "cancel" == b && "left" == g && 0 === e ? j(0, f.speed) : "end" == b && "left" == g ? k() : "end" != b && "cancel" != b || "right" != g || console.log("end") }

        function h() { return /Safari/.test(navigator.userAgent) && /Apple Computer/.test(navigator.vendor) }

        function i() { return /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor) }
        ...
        a(".ssm-toggle-nav").click(function(a) { c.hasClass("ssm-nav-visible") ? k() : l(), a.preventDefault() })
    }
